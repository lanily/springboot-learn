/**
 * Copyright (C), 2015-2020, XXX有限公司 FileName: RedisCacheProviderImpl Author: xiao Date: 2020/11/14
 * 21:50 History: <author> <time> <version> <desc> 作者姓名 修改时间 版本号 描述
 */
package com.hsiao.springboot.cache.service;

import com.hsiao.springboot.cache.AppConst;
...
public class RedisCacheProviderImpl implements CacheProviderService {
  ...
  @Resource private RedisTemplate<Serializable, Object> redisTemplate;
   ...
   */
  public <T extends Object, M extends Object> T get(
      String key, Function<M, T> function, M funcParm) {
   ...
   */
  public <T extends Object, M extends Object> T get(
      String key, Function<M, T> function, M funcParm, Long expireTime) {
    T obj = null;
