...
import com.hsiao.springboot.websocket.netty.server.ServerEndpointConfig;
import com.hsiao.springboot.websocket.netty.server.Session;
import com.hsiao.springboot.websocket.netty.support.AntPathMatcherWrapper;
import com.hsiao.springboot.websocket.netty.support.DefaultPathMatcher;
...
import com.hsiao.springboot.websocket.netty.support.WebSocketPathMatcher;
...
public class PojoEndpointServer {
    ...
    private static final AttributeKey<Object> POJO_KEY = AttributeKey
            .valueOf("WEBSOCKET_IMPLEMENT");

    public static final AttributeKey<Session> SESSION_KEY = AttributeKey
            .valueOf("WEBSOCKET_SESSION");
    ...
    private Set<WebSocketPathMatcher> pathMatchers = new HashSet<>();
    ...
    public void doBeforeHandshake(Channel channel, FullHttpRequest req, String path) {
        ...
        if (beforeHandshake != null) {
            try {
                beforeHandshake
                        .invoke(implement, methodMapping.getBeforeHandshakeArgs(channel, req));
    ...
    public Set<WebSocketPathMatcher> getPathMatcherSet() {
        return pathMatchers;
    }
    ...
    public void addPathPojoMethodMapping(String path, PojoMethodMapping pojoMethodMapping) {
        ...
        for (MethodArgumentResolver onOpenArgResolver : pojoMethodMapping.getOnOpenArgResolvers()) {
            logger.info(String.valueOf(
                    (onOpenArgResolver instanceof PathVariableMethodArgumentResolver)));
            logger.info("type: " + onOpenArgResolver.getClass().getTypeName());
