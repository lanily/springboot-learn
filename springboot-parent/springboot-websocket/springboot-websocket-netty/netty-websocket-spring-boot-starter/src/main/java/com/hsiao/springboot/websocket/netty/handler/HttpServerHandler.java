...
public class HttpServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
  ...
  private void handleHttpRequest(ChannelHandlerContext ctx, FullHttpRequest req) {
    ...
    // path match
    String pattern = null;
    Set<WebSocketPathMatcher> pathMatcherSet = pojoEndpointServer.getPathMatcherSet();
    for (WebSocketPathMatcher pathMatcher : pathMatcherSet) {
    ...
    if (handshaker == null) {
      ...
      /*
                                ...
                                */
//                                ch.pipelineipeline().addLast(new WebSocketServerProtocolHandler(webSocketPath,WEBSOCKET_PROTOCOL, true, 65536 * 10));
        // 自定义的handler，处理业务逻辑
