...
public class MultiQueryServiceImplTest {

    private static final Logger logger = LoggerFactory.getLogger(MultiQueryServiceImplTest.class);
    @Autowired
    ...
    public void pageByEntity() {
        ...
        Page<Klass> klassPage =
                (Page<Klass>) multiQueryService.page(klassRepository, klass, pageRequest);
        ...
        klassPage = (Page<Klass>) multiQueryService.page(klassRepository, klass, pageRequest);
    ...
    public void findAllByEntity() {
        ...
        Klass klass = this.initQueryKlass();
        List<Klass> klassPage = (List<Klass>) multiQueryService.findAll(klassRepository, klass);
        ...
        teacher.setAddress(originKlass.getTeacher().getAddress());
        klass.setTeacher(teacher);
        klassPage = (List<Klass>) multiQueryService.findAll(klassRepository, klass);
        Assertions.assertThat(klassPage.size()).isEqualTo(1);
    }
