...
import com.hsiao.springboot.multiquery.annotation.BeginQueryParam;
import com.hsiao.springboot.multiquery.annotation.EndQueryParam;
import com.hsiao.springboot.multiquery.annotation.IgnoreQueryParam;
import com.hsiao.springboot.multiquery.entity.AbstractEntity;
...
public class MultiQueryServiceImpl implements MultiQueryService {
    private static final Logger logger = LoggerFactory.getLogger(MultiQueryServiceImpl.class);
                    ...
                    for (Field field : fields) {
                        ...
                        if (value != null) {
                            ...
                            if (value instanceof String) {
                                ...
                                logger.debug("是实体类");
                                AbstractEntity yunZhiAbstractEntity = (AbstractEntity) value;
